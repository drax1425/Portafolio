...
export default function Skills({ t }) {
  const techStack = [
    ...
    { name: 'JavaScript',    icon: 'JS', color: '#f7df1e', badge: true },
    { name: 'TypeScript',    icon: 'TS', color: '#3178c6', badge: true },
          ...
          {techStack.map((tech, i) => (
            ...
            >
              <div className="mb-4 h-10 flex items-center justify-center">
                {tech.badge ? (
                  <span
                    className="flex items-center justify-center w-10 h-10 rounded-lg font-black text-sm font-mono grayscale group-hover:grayscale-0 transition-all duration-300"
                    style={{
                  ...
                  <span
                    className="text-4xl grayscale group-hover:grayscale-0 transition-all duration-300"
              ...
              <span className="text-slate-300 font-medium group-hover:text-slate-100 transition-colors text-center">
                {tech.name}
              </span>
            </motion.div>
          ))}
